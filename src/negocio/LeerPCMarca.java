...
public class LeerPCMarca extends SwingWorker<Integer, Void>{
	...
	public LeerPCMarca( VentanaAsistente miVentanaAsistente,WebScrollPane scrollPane, WebTable table, WebProgressBar jProgressBar, JLabel lblProcesando) {
	...
	protected Integer doInBackground() throws Exception {
		...
		Document document = Jsoup.connect("http://www.magitech.pe/computadoras/pc-de-marca.html").get();
		...
		document = Jsoup.connect("http://www.magitech.pe/computadoras/pc-de-marca.html?p=2").get();

		entradas = document.select("li.item");
		links = document.select("h2.product-name > a");

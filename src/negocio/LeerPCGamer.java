...
public class LeerPCGamer extends SwingWorker<Integer, Void>{
	...
	public LeerPCGamer( VentanaAsistente miVentanaAsistente,WebScrollPane scrollPane, WebTable table, WebProgressBar jProgressBar, JLabel lblProcesando) {
	...
	protected Integer doInBackground() throws Exception {
		...
		Document document = Jsoup.connect("http://www.magitech.pe/computadoras/pc-gamer.html").get();

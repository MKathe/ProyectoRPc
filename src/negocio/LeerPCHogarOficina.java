...
public class LeerPCHogarOficina extends SwingWorker<Integer, Void>{
	...
	public LeerPCHogarOficina( VentanaAsistente miVentanaAsistente,WebScrollPane scrollPane, WebTable table, WebProgressBar jProgressBar, JLabel lblProcesando) {
	...
	protected Integer doInBackground() throws Exception {
		...
		Document document = Jsoup.connect("http://www.magitech.pe/computadoras/hogar-oficina.html").get();
